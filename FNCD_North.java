...
public class FNCD_North extends Buyer {
...
if ( type.equals("ElectricTrucks"))
    ...
    ArrayList<Vehicle> inventoryList,FileWriter writer, Logger logger, Tracker tracker) throws IOException {
       writer.write("Opening North Branch....(current budget $"+operatingBudget+")\n");
        System.out.println("Opening North Branch....(current budget $"+operatingBudget+")");
        logger.setDescription("\n Opening North Branch....");
        tracker.setTrackerDescription("Opening North Branch budget $"+operatingBudget);
...
public static void washing( ArrayList<Staff> s, ArrayList<Vehicle> v, FileWriter writer, Logger logger) throws IOException {
    writer.write("Washing North Branch....\n");
    System.out.println("Washing North Branch....");
    logger.setDescription("\n");
    //logger.setDescription("\n Washing....");
    int washCount = 0;
...
public static void repairing(ArrayList<Staff> s, ArrayList<Vehicle> v,FileWriter writer, Logger logger ) throws IOException {
   ...
   writer.write("Repairing North Branch....\n");
    System.out.println("Repairing North Branch....");
    logger.setDescription("\n");
  //  logger.setDescription("\n Repairing....");
  ...
  ArrayList<Vehicle> invList , FileWriter writer, Logger logger, Tracker tracker) throws IOException
  {
    ...
    System.out.println("Selling North Branch....");
    writer.write("Selling North Branch....\n");
    logger.setDescription("\n");
   // logger.setDescription("\nSelling....");
    int numOfBuyers =0;
    Random random = new Random();
...
{ int raceCount = 0;
  int carCount = 0;
  int count =0;
  System.out.println("Racing North Branch............");
  writer.write("\n Racing North Branch............ \n");
  logger.setDescription("Racing North Branch............");
 ...
 List<Integer> pos = IntStream.rangeClosed(1, 20).boxed().collect(Collectors.toList());
  ...
  { 
    System.out.println("Ending North Branch....");
    logger.setDescription("\n Ending North Branch ....");
